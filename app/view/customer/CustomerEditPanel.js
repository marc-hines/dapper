...
Ext.define("dapper.view.customer.CustomerEditPanel",{
    "extend": "Ext.form.Panel",
    "controller": "customer-customereditpanel",
    "viewModel": {
        "type": "customer-customereditpanel"
    },
    
    requires: [
        'Ext.form.*',
        'dapper.model.CustomerModel',
    ...
    initComponent: function() {
        ...
        var customerEditStore = Ext.create('Ext.data.Store', {
            ...
            autoSync: true,
            autoDestroy: true,
            model: 'dapper.model.CustomerModel',
            proxy: {
                type: 'rest',
