        ...
        var searchCustomersButton = Ext.create('Ext.Button', {
            ...
            listeners: {
                click: function() {
                    ...
                    var searchResultsGrid =  Ext.create('dapper.view.customer.CustomerGridPanel', {
        ...
        var searchJobsButton = Ext.create('Ext.Button', {
            ...
            listeners: {
                click: function() {
                    ...
                    var searchResultsGrid =  Ext.create('dapper.view.job.JobGridPanel', {
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        y: 0,
                        xtype: 'image',
                        src: 'resources/images/glassmasterslogo.gif',
                        width: 380
                    }, searchTextField,
