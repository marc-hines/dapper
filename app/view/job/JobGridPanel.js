...
Ext.define("dapper.view.job.JobGridPanel",{
    "extend": "Ext.grid.GridPanel",
    "controller": "job-jobgridpanel",
    "viewModel": {
        "type": "job-jobgridpanel"
    },
    ...
    initComponent: function(){
        ...
        var gridStore = Ext.create('Ext.data.Store', {
            ...
            autoSync: true,
            autoDestroy: true,
            model: 'dapper.model.JobGridModel',
            proxy: {
                type: 'rest',
                url: restUrl,
                reader: {
            ...
            listeners: {
                click: function() {
                    ...
                    if (alreadyCreatedView == null) {
                        var view = Ext.create('dapper.view.job.JobEditView', {
                            title: 'New Job',
                            id: viewId,
                            job_dbid: null});
                        tabpanel.add(view);
