...
Ext.define("dapper.view.receivables.CollectionSummaryGridView",{
    "extend": "Ext.grid.GridPanel",
    "controller": "receivables-collectionsummarygridview",
    "viewModel": {
        "type": "receivables-collectionsummarygridview"
    },
    ...
    requires: [
        'Ext.grid.*',
        'dapper.model.CollectionSummaryGridModel'
    ],
    ...
    initComponent: function(){
        ...
        var gridStore = Ext.create('Ext.data.Store', {
            ...
            autoSync: true,
            autoDestroy: true,
            model: 'dapper.model.CollectionSummaryGridModel',
            proxy: {
                type: 'rest',
